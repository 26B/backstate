...
namespace TwentySixB\BackState\Livewire;

use Illuminate\Database\Eloquent\Builder;
use Illuminate\Support\Arr;
use Livewire\Component;
use TwentySixB\BackState\Livewire\Table\WithPagination;
use TwentySixB\BackState\Livewire\Table\WithFilteredSearch;
use TwentySixB\BackState\Livewire\Table\WithSort;

abstract class Table extends Component
{
    use WithPagination {
        getQueryString as private getQueryStringPagination;
    }
    // FIXME: Importing same methods `getQueryString()` is breaking php without any logs.
    // use WithFilteredSearch {
    //     getQueryString as private getQueryStringSearch;
    // }
    use WithSort;
    ...
    // FIXME: Stubs to prevent execution from breaking due to removing `WithFilteredSearch`
    public $search = '';

    // FIXME: Stubs to prevent execution from breaking due to removing `WithFilteredSearch`
    public function getQueryStringSearch() : array
    {
        return [];
    }

    // FIXME: Stubs to prevent execution from breaking due to removing `WithFilteredSearch`
    public function getCurrentSearchFilter() : array
    {
        return [];
    }
