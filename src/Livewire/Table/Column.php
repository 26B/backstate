...
class Column
{
     ...
     *
     * @see TwentySixB\BackState\Livewire\Table::__construct
     */
    ...
    public function __construct(string $title, $getData = null)
    {
        ...
        $this->dataViewComponent = 'backstate::components.table.data.default';
        $this->headerViewComponent = 'backstate::components.table.header.default';
        $this->title = $title;
